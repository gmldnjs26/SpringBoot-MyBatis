...
<%@ include file="sub_menu.html" %>
  <article>
    <h2>Join Us</h2>
    <form id="join" action="join_form.do" method="post" name="formm">
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
      ...
      <label><input type="radio" name="okon1" checked> 同意する </label> &nbsp; &nbsp; &nbsp;
      <label><input type="radio" name="okon1" checked> 同意しない </label>
      </div>
